...
trafos %>% 
  ...
  geom_pointrange(position = position_dodge(0.4), size = 0.3) +
  ggrepel::geom_text_repel(aes(label = sprintf("%.2f", estimate)), size = 2.5, position = position_dodge(0.4)) +
  coord_flip() +
  theme_bw() + 
  scale_color_viridis_d(begin = 0.2, end = 0.8) +
...
ggsave("plots/S_Figure7.pdf", width = 14.22, height = 10, units = "in")
ggsave("plots/S_Figure7.png", width = 14.22, height = 10, units = "in")
...
ggsave("plots/Supplementary_Figure3.pdf", width = 14, height = 8, units = "in")
ggsave("plots/Supplementary_Figure3.png", width = 14, height = 8, units = "in")
```
