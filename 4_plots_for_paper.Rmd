...
knitr::opts_chunk$set(echo = TRUE, warning = TRUE, message = TRUE, error = T)
```
...
sd_unrestricted <- sd(lh_days$est_estradiol_lh,na.rm=T)
...
sd_unrestricted <- sd(lh_days$est_progesterone_lh,na.rm=T)
